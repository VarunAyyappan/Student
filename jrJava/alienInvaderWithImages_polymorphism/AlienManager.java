...
public class AlienManager {
	...
	public static void create(){
		...
		if(rand>=0.80){
			alien = new SimpleAlien(x, -10, vx, vy, images1[imageIndex], images2[imageIndex] );
		}
		else if(rand>=0.60){
			alien = new SimpleAlien(x, -10, vx, vy, images1[imageIndex], images2[imageIndex] );
		}
		else if(rand>=0.40){
			alien = new CloakAlien(x, -10, vx, vy, images1[imageIndex], images2[imageIndex] );
		}
		else if(rand>=0.20){
			alien = new RealNastyAlien(x, -10, vx, vy, images1[imageIndex], images2[imageIndex] );
		}
		else {
			alien = new MultiShootAlien(x, -10, vx, vy, images1[imageIndex], images2[imageIndex] );
		}
